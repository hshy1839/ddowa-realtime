  ...
  private buildSystemInstruction(): string {
    ...
    return [
      ...
      this.liveConfig.fallback
        ...
        : '',
      '\n[예약 응대 핵심 규칙]\n- 예약 확정/가능 여부를 단정하지 말고, 반드시 \"확인해볼게요\" 후 안내하세요.\n- 예약 요청이면 필요한 슬롯을 순서대로 수집하세요: ①날짜/시간 ②전화번호 ③서비스명.\n- 정보가 하나라도 없으면 짧은 질문 1개로 보충 유도하세요.\n- 시간 충돌 시 즉시 \"해당 시간은 이미 예약이 있어요\"라고 말하고 대체 시간(예: 11시/1시) 제안 질문을 하세요.\n- 전화번호는 끊어 말해도 재확인해서 받으세요(예: 010-1234-5678 맞으실까요?).\n- 서비스명(예: 일반펌/열펌/커트)을 반드시 한 번은 확인 질문하세요.',
